...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=38", "js/app.js?v=38", "js/dict.js?v=38", "manifest.webmanifest"]).catch(() => {})),
