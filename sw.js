...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=45", "js/app.js?v=45", "js/dict.js?v=45", "js/tr-engine.js?v=45", "manifest.webmanifest"]).catch(() => {})),
