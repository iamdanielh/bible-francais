...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=41", "js/app.js?v=41", "js/dict.js?v=41", "manifest.webmanifest"]).catch(() => {})),
