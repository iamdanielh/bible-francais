...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=42", "js/app.js?v=42", "js/dict.js?v=42", "manifest.webmanifest"]).catch(() => {})),
