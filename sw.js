...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=37", "js/app.js?v=37", "js/dict.js?v=37", "manifest.webmanifest"]).catch(() => {})),
