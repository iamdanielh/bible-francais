...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=35", "js/app.js?v=35", "js/dict.js?v=35", "manifest.webmanifest"]).catch(() => {})),
