...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=55", "js/app.js?v=59", "js/dict.js?v=45", "js/tr-engine.js?v=47", "js/en-engine.js?v=3", "manifest.webmanifest"]).catch(() => {})),
