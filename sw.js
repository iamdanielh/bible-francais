...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=43", "js/app.js?v=43", "js/dict.js?v=43", "manifest.webmanifest"]).catch(() => {})),
