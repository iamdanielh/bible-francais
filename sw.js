...
self.addEventListener("install", (event) => {
  event.waitUntil(
    Promise.all([
      caches.open(CACHE).then((cache) => cache.addAll(["./", "index.html", "css/style.css?v=44", "js/app.js?v=44", "js/dict.js?v=44", "js/tr-engine.js?v=44", "manifest.webmanifest"]).catch(() => {})),
